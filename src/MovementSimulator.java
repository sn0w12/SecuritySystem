...
public class MovementSimulator {
    public static void simulateBackyardMovement(List<String> rooms, int userRoom, boolean securityOn, Random random) {
        ...
        if (securityOn && userRoom == 9) {
            ...
            BreakInSimulator.simulateBreakIn(1, rooms, userRoom, securityOn, random);
        }
        Main.pause();
    }
}